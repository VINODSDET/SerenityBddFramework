...
## Executing the tests
To run the sample project, you can either just run the `CucumberTestSuite` test com.vinod.serenity.bdd.runner class, or run either `mvn verify` or `gradle test` from the command line.
